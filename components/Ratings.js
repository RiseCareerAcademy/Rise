    ...
    render() {
        ...
        return (
            <Container style={styles.container}>
                <Text style={styles.center}>Rate {first_name} {last_name}</Text>
                <StarRating
                disabled={false}
                maxStars={5}
            ...
            <Item stackedLabel>
            <Label>Did you experience any difficulties or challenges in your relationship with your mentor?</Label>
            <Input
              placeholder="Enter response"
          ...
          <Item stackedLabel>
          <Label>Was there anything that your mentor did particularly well?</Label>
          <Input
            placeholder="Enter response"
